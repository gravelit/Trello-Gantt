...
class Scatter(_BaseTraceType):
    ...
    def percent(self):
        """
        A percentage complete for each task
    ...
    def taskname(self):
        ...
        The 'taskname' property is a string and must be specified as:
          - A string
          - A number that will be converted to a string
...
an instance of :class:`plotly.graph_objs.Scatter`"""
        ...
        _v = arg.pop("percent", None)
        _v = percent if percent is not None else _v
        if _v is not None:
            self["percent"] = _v
        ...
        _v = arg.pop("taskname", None)
        _v = taskname if taskname is not None else _v
        if _v is not None:
            self["taskname"] = _v
